...
ACoruña: { name: "A Coruña", color: DiseaseColor.Blue, coords: { x: 12.93, y: 18.23 }, population: 0, foundingDate: -150},
SangiagoDeCompostela: { name: "Santiago de Compostela", color: DiseaseColor.Blue, coords: { x: 12.55, y: 23.44 }, population: 0, foundingDate: 813 },
Ourense: { name: "Ourense", color: DiseaseColor.Blue, coords: { x: 20.53, y: 28.13 }, population: 0, foundingDate: -100 },
Vigo: { name: "Vigo", color: DiseaseColor.Blue, coords: { x: 11.03, y: 30.21 }, population: 0, foundingDate: -101 },
Braga: { name: "Braga", color: DiseaseColor.Blue, coords: { x: 18.63, y: 36.98 }, population: 0, foundingDate: -16 },
Porto: { name: "Porto", color: DiseaseColor.Blue, coords: { x: 11.79, y: 41.15 }, population: 0, foundingDate: -300 },
Salamanca: { name: "Salamanca", color: DiseaseColor.Blue, coords: { x: 28.52, y: 43.75 }, population: 0, foundingDate: -400 },
Coimbra: { name: "Coimbra", color: DiseaseColor.Blue, coords: { x: 17.11, y: 51.04 }, population: 0, foundingDate: -50 },
Cáceres: { name: "Cáceres", color: DiseaseColor.Blue, coords: { x: 24.71, y: 57.81 }, population: 0, foundingDate: -25 },
Lisboa: { name: "Lisboa", color: DiseaseColor.Blue, coords: { x: 9.13, y: 65.63 }, population: 0, foundingDate: -1200 },
Évora: { name: "Évora", color: DiseaseColor.Blue, coords: { x: 16.35, y: 67.19 }, population: 0, foundingDate: -57 },
Albufeira: { name: "Albufeira", color: DiseaseColor.Blue, coords: { x: 13.69, y: 81.25 }, population: 0, foundingDate: -200 },
AndorraLaVella: { name: "Andorra la Vella", color: DiseaseColor.Yellow, coords: { x: 68.82, y: 27.08 }, population: 0, foundingDate: 805 },
Girona: { name: "Girona", color: DiseaseColor.Yellow, coords: { x: 76.05, y: 32.81 }, population: 0, foundingDate: -77 },
Zaragoza: { name: "Zaragoza", color: DiseaseColor.Yellow, coords: { x: 55.51, y: 36.46 }, population: 0, foundingDate: -14 },
Barcelona: { name: "Barcelona", color: DiseaseColor.Yellow, coords: { x: 72.24, y: 39.06 }, population: 0, foundingDate: -15  },
Tarragona: { name: "Tarragona", color: DiseaseColor.Yellow, coords: { x: 64.26, y: 42.71 }, population: 0, foundingDate: -218 },
Teruel: { name: "Teruel", color: DiseaseColor.Yellow, coords: { x: 53.99, y: 50 }, population: 0, foundingDate: 1171 },
Cuenca: { name: "Cuenca", color: DiseaseColor.Yellow, coords: { x: 48.29, y: 52.6 }, population: 0, foundingDate: 784 },
PalmaDeMallorca: { name: "Palma de Mallorca", color: DiseaseColor.Yellow, coords: { x: 72.62, y: 56.77 }, population: 0, foundingDate: -123 },
Valencia: { name: "Valencia", color: DiseaseColor.Yellow, coords: { x: 57.79, y: 58.33 }, population: 0, foundingDate: -138 },
Albacete: { name: "Albacete", color: DiseaseColor.Yellow, coords: { x: 49.81, y: 63.02 }, population: 0, foundingDate: 1200 },
Alicante: { name: "Alicante", color: DiseaseColor.Yellow, coords: { x: 57.41, y: 69.27 }, population: 0, foundingDate: -324 },
Cartagena: { name: "Cartagena", color: DiseaseColor.Yellow, coords: { x: 54.75, y: 76.56 }, population: 0, foundingDate: -228 },
Toledo: { name: "Toledo", color: DiseaseColor.Black, coords: { x: 33.46, y: 53.65 }, population: 0, foundingDate: -202 },
CiudadReal: { name: "Ciudad Real", color: DiseaseColor.Black, coords: { x: 38.4, y: 63.02 }, population: 0, foundingDate: 1255 },
Badajoz: { name: "Badajoz", color: DiseaseColor.Black, coords: { x: 21.29, y: 64.06 }, population: 0, foundingDate: 875 },
Jaén: { name: "Jaén", color: DiseaseColor.Black, coords: { x: 40.3, y: 71.35 }, population: 0, foundingDate: -253 },
Córdoba: { name: "Córdoba", color: DiseaseColor.Black, coords: { x: 33.46, y: 73.44 }, population: 0, foundingDate: -206 },
Granada: { name: "Granada", color: DiseaseColor.Black, coords: { x: 41.44, y: 78.65 }, population: 0, foundingDate: -500 },
Sevilla: { name: "Sevilla", color: DiseaseColor.Black, coords: { x: 27, y: 79.17 }, population: 0, foundingDate: -800 },
Huelva: { name: "Huelva", color: DiseaseColor.Black, coords: { x: 21.29, y: 79.69 }, population: 0, foundingDate: -1000 },
Almería: { name: "Almería", color: DiseaseColor.Black, coords: { x: 46.39, y: 83.85 }, population: 0, foundingDate: 955 },
Málaga: { name: "Málaga", color: DiseaseColor.Black, coords: { x: 35.36, y: 84.9 }, population: 0, foundingDate: -770 },
Cádiz: { name: "Cádiz", color: DiseaseColor.Black, coords: { x: 25.1, y: 87.5 }, population: 0, foundingDate: -1104 },
Gibraltar: { name: "Gibraltar", color: DiseaseColor.Black, coords: { x: 29.66, y: 90.63 }, population: 0, foundingDate: 711 },
SanSebastiánDonostia: { name: "San Sebastián-Donostia", color: DiseaseColor.Red, coords: { x: 50.19, y: 17.19 }, population: 0, foundingDate: 1180 },
Gijón: { name: "Gijón", color: DiseaseColor.Red, coords: { x: 28.9, y: 16.15 }, population: 0, foundingDate: -100 },
Santander: { name: "Santander", color: DiseaseColor.Red, coords: { x: 38.78, y: 17.71 }, population: 0, foundingDate: -26 },
BilbaoBilbo: { name: "Bilbao-Bilbo", color: DiseaseColor.Red, coords: { x: 44.11, y: 19.79 }, population: 0, foundingDate: 1300 },
Pamplona: { name: "Pamplona", color: DiseaseColor.Red, coords: { x: 50.95, y: 24.48 }, population: 0, foundingDate: -74 },
VitoriaGasteiz: { name: "Vitoria-Gasteiz", color: DiseaseColor.Red, coords: { x: 45.63, y: 27.6 }, population: 0, foundingDate: 1181 },
León: { name: "León", color: DiseaseColor.Red, coords: { x: 28.9, y: 26.56 }, population: 0, foundingDate: -29 },
Burgos: { name: "Burgos", color: DiseaseColor.Red, coords: { x: 39.54, y: 29.17 }, population: 0, foundingDate: 884 },
Huesca: { name: "Huesca", color: DiseaseColor.Red, coords: { x: 58.17, y: 30.21 }, population: 0, foundingDate: -40 },
Valladolid: { name: "Valladolid", color: DiseaseColor.Red, coords: { x: 33.84, y: 36.46 }, population: 0, foundingDate: 1072 },
Soria: { name: "Soria", color: DiseaseColor.Red, coords: { x: 44.87, y: 37.5 }, population: 0, foundingDate: -150 },
Madrid: { name: "Madrid", color: DiseaseColor.Red, coords: { x: 39.54, y: 48.44 }, population: 0, foundingDate: 865 },
} as const;
...
Valencia: ["Tarragona", "PalmaDeMallorca", "Alicante", "PalmaDeMallorca", "Albacete", "Cuenca"],
...
CiudadReal: ["Toledo", "Madrid", "Albacete", "Córdoba", "Badajoz"],
...
triggeredBy?: { effect: HistoricalDiseaseEffect; sourceCity: CityName };
}
...
activeHistoricalDiseases: HistoricalDiseaseEffect[];
...
useHistoricalDiseasesChallenge: boolean;
numHistoricalDiseases: number; 
}
