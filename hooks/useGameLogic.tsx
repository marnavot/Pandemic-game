...
export const useGameLogic = () => {
    ...
    const handleStartGame = (config: GameSetupConfig, hostId: number | null): GameState => {
        ...
        const initialGameState: GameState = {
            ...
            legions: [],
            aleaIactaEstStatus: 'inactive',
            abundansCautelaStatus: 'inactive',
            veniVidiViciStatus: 'inactive',
            purificationTokens: {},
            purificationTokenSupply: 0,
            phaseBeforePurificationChoice: null,
            pendingPurificationChoice: null,
            pendingAgronomistPurifyChoice: null,
            pendingRuralDoctorChoice: null,
            infectionContinuation: null,
            nursePreventionTokenLocation: null,
            hasUsedRailwaymanDoubleBuild: false,
            pendingRailwaymanBuild: null,
            pendingScienceTriumphChoice: null,
            railroads: [],
            hospitals: {
